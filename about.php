...
<html>
    ...
    <body>
		...
		<div class="page">
			...
			<p>Le projet Doochronos est codé en HTML 5, CSS 3, PHP, JavaScript et jQuery. Le projet utilise également un autre projet intitulé <a href="http://daneden.github.io/animate.css/">"Animate.css"</a> créé par Daniel Eden, placé sous licence MIT.</p>
		</div>
    </body>
</html>